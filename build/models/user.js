...
var user_table = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [u.username, u.first_name, u.last_name, u.password])];
                    case 2:
                        result = _a.sent();
                        user = result.rows[0];
                        conn.release();
    ...
    user_table.prototype.update = function (id, newdata) {
        return __awaiter(this, void 0, void 0, function () {
            var username, first_name, last_name, password, sql, conn, result, user, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        username = newdata.username, first_name = newdata.first_name, last_name = newdata.last_name, password = newdata.password;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        sql = "UPDATE users SET username = $1, first_name = $2, last_name= $3, password= $4 WHERE id = $5 RETURNING *";
                        return [4 /*yield*/, database_1.default.connect()];
                    case 2:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [username, first_name, last_name, password, id])];
                    case 3:
                        result = _a.sent();
                        user = result.rows[0];
                        conn.release();
