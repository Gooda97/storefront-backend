...
var _a = process.env, PEPPER = _a.PEPPER, TOKEN_SECRET = _a.TOKEN_SECRET;
...
var authenticate = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, table.authenticate(username, password)];
            case 2:
                valid = _b.sent();
                token = jwt.sign({ username: username, valid: valid }, TOKEN_SECRET);
                if (!valid) {
                    res.status(401);
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, table.update(user)];
            case 2:
                updated = _a.sent();
                res.json(updated);
                return [3 /*break*/, 4];
